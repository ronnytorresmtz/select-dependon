...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-select-depend-on', __webpack_require__(5));
    Vue.component('detail-select-depend-on', __webpack_require__(8));
    Vue.component('form-select-depend-on', __webpack_require__(11));
    ...
    Nova.store = new __WEBPACK_IMPORTED_MODULE_0_vuex__["a" /* default */].Store({
        ...
        actions: {
            addSelectOption: function addSelectOption(context, data) {
