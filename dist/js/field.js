...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-select-depend-on', __webpack_require__(3));
    Vue.component('detail-select-depend-on', __webpack_require__(6));
    Vue.component('form-select-depend-on', __webpack_require__(9));
});
