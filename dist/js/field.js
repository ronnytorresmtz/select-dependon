...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-SelectDependOn', __webpack_require__(3));
    Vue.component('detail-SelectDependOn', __webpack_require__(6));
    Vue.component('form-SelectDependOn', __webpack_require__(9));
